...
void EditorCamera::Update()
{
    ...
    bool isPushCtrl = GameDevice()->m_pDI->CheckKey(KD_DAT, DIK_LCONTROL) || GameDevice()->m_pDI->CheckKey(KD_DAT, DIK_RCONTROL);
    bool isPushAlt = GameDevice()->m_pDI->CheckKey(KD_DAT, DIK_LALT) || GameDevice()->m_pDI->CheckKey(KD_DAT, DIK_RALT);
    bool isPushShift = GameDevice()->m_pDI->CheckKey(KD_DAT, DIK_LSHIFT) || GameDevice()->m_pDI->CheckKey(KD_DAT, DIK_RSHIFT);

...
// ��ʂ̊g�k�����̂��߃E�C���h�E�̏����T�C�Y��ǉ�                   // -- 2020.8.7
...
// 
//   ��ʂ̊g�k�����ɑΉ��ł���悤��
//   �E�C���h�E�̏����T�C�Y��ݒ肷��     int WidthIn, int HeightIn   // -- 2020.8.7
// 
bool    ImGui_ImplWin32_Init(void* hwnd, int WidthIn, int HeightIn)
//bool    ImGui_ImplWin32_Init(void* hwnd)    // ���̓��e
{
